...
class QuizFisika extends StatefulWidget{
  const QuizFisika({Key? key}) :super(key: key);
  @override
  _QuizFisikaState createState() => _QuizFisikaState();
}

class _QuizFisikaState extends State<QuizFisika> with TickerProviderStateMixin{
  var db = DBconnect3();
      ...
      builder: (ctx, snapshot){
        if(snapshot.connectionState== ConnectionState.done){
          if(snapshot.hasError){
            ...
            return Scaffold(
              appBar: AppBar(
                title: const Text('Fisika',style: TextStyle(color: Colors.black),),
                centerTitle: true,
